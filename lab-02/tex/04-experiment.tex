...
Результаты профилирования алгоритмов приведены в таблице \ref{tab:time}.
\begin{table}[ht!]
...
На графике \ref{fig:w-plot} представлен время выполнения программы с матрицами нечетной размерности.
