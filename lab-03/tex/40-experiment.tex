...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			semithick,
			mark = *,
			] file {assets/radix_r.dat};
			
			\addplot[
			green,
			semithick,
			mark = *,
			] file {assets/binary_r.dat};
	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
				...
				mark size = 3pt,
				thick,
				] file {assets/count_u.dat};
				
				\addplot[
				red,
				semithick,
				mark = *,
				] file {assets/radix_u.dat};
				
				\addplot[
				green,
				semithick,
				mark = *,
				] file {assets/binary_u.dat};
		...
		\end{tikzpicture}
	\end{center}
	\caption{Результаты замеров реализаций сортировок, входными данными являлись отсортированные по возрастанию значений массивы.}
	\label{graph:r}
\end{figure}
	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
				...
				mark size = 3pt,
				thick,
				] file {assets/count_d.dat};
				
				\addplot[
				red,
				semithick,
				mark = *,
				] file {assets/radix_d.dat};
				
				\addplot[
				green,
				semithick,
				mark = *,
				] file {assets/binary_d.dat};
